    ...
    execute: function () {
      ...
      PopUpLabelAssembler = class PopUpLabelAssembler {
        ...
        updateVertexData(comp) {
          ...
          comp.anims.forEach(anim => {
            ...
            for (let letterIndex = 0; letterIndex < anim.len; letterIndex++, letterCount++) {
              const x = scale * anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 0];
              const y = scale * anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 1];
              const w = scale * anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 2];
              const h = scale * anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 3];
              const offsetx = scale * anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 4];
              const offsety = scale * anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
        ...
        updateUVs(comp) {
          ...
          comp.anims.forEach(anim => {
            for (let letterIndex = 0; letterIndex < anim.len; letterIndex++, letterCount++) {
              const x = anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 0];
              const y = anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 1];
              const w = anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 2];
              const h = anim.layout[letterIndex * (_crd && LabelAnimRuntimeInfo === void 0 ? (_reportPossibleCrUseOfLabelAnimRuntimeInfo({
                error: Error()
              }), LabelAnimRuntimeInfo) : LabelAnimRuntimeInfo).LetterOffset + 3];
