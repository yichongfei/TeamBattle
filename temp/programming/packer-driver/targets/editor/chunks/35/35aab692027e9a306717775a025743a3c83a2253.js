    ...
    execute: function () {
      ...
      _export("PlayerSquadManager", PlayerSquadManager = (_dec = ccclass('PlayerSquadManager'), _dec(_class = (_class2 = class PlayerSquadManager extends Component {
        ...
        getAlivePlayerCharacters() {
          ...
          this.squadMembers.forEach((index, node) => {
            if (node && isValid(node)) {
              const healthComp = node.getComponent(_crd && HealthComponent === void 0 ? (_reportPossibleCrUseOfHealthComponent({
                error: Error()
        ...
        broadcastSquadLists() {
          ...
          all.forEach(node => {
            const move = node.getComponent(_crd && MovementComponent === void 0 ? (_reportPossibleCrUseOfMovementComponent({
              error: Error()
