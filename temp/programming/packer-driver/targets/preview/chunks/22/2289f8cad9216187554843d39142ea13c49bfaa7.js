    ...
    execute: function () {
      ...
      _export("LabelAnimRuntimeInfo", LabelAnimRuntimeInfo = (_dec = (_crd && ObjectPool === void 0 ? (_reportPossibleCrUseOfObjectPool({
        ...
        update(dt) {
          ...
          var r = easing[this.data.ease](this.progress);
        ...
        _prepareLayoutData(font, spacingX) {
          ...
          var fontHeight = font.fntConfig.commonHeight;
          var indexOffset = 0;
          var letterW = 0;
          ...
          for (var i = 0; i < this.len; i++) {
             ...
             */
            var config = font.fntConfig.fontDefDictionary[this.data.text.charCodeAt(i)];
          ...
          for (var _i = 0; _i < this.len; _i++) {
            this.layout[_i * LabelAnimRuntimeInfo.LetterOffset + 4] -= letterW / 2;
          }
        }
