    ...
    execute: function () {
      ...
      _export("AttackComponent", AttackComponent = (_dec = ccclass('AttackComponent'), _dec2 = property(_crd && CharacterStats === void 0 ? (_reportPossibleCrUseOfCharacterStats({
        ...
        tryAttack() {
          ...
          const damageableTarget = targetNode.getComponent(_crd && HealthComponent === void 0 ? (_reportPossibleCrUseOfHealthComponent({
            error: Error()
        ...
        performAttack(target) {
          ...
          const damageable = targetNode.getComponent(_crd && HealthComponent === void 0 ? (_reportPossibleCrUseOfHealthComponent({
            error: Error()
          }), HealthComponent) : HealthComponent);
          ...
          const attackType = (_crd && AttackType === void 0 ? (_reportPossibleCrUseOfAttackType({
            error: Error()
          }), AttackType) : AttackType).PHYSICAL;
          this.scheduleOnce(() => {
            const currentDamageable = targetNode.getComponent(_crd && HealthComponent === void 0 ? (_reportPossibleCrUseOfHealthComponent({
              error: Error()
            }), HealthComponent) : HealthComponent);
